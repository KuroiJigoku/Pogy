...
logger.info(`✅ loaded Maintenance Mode `, { label: 'Status' })
    ...
    const activities = [
      { name: 'radcliff.cf', type: 'WATCHING' }, 
      { name: 'radcliff.cf', type: 'WATCHING' }
    ];
    ...
    setInterval(() => {
      activities[2] = { name: `radcliff.cf | ${ this.client.guilds.cache.size} guilds`, type: 'WATCHING' };
      activities[3] = { name: `radcliff.cf | ${ this.client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)} users`, type: 'WATCHING' }; 
