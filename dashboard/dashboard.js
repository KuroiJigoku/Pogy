...
res.redirect(`https://discord.com/oauth2/authorize?client_id=${process.env.client}&redirect_uri=${domain}/thanks&response_type=code&scope=bot&permissions=490073207`)
});
...
let embed;
  ...
  if(data[i + 1]){
    ...
    .setFooter('Modified by HarryPuttar5832')
    .setColor('GREEN')
...
member.send(new MessageEmbed().setColor('GREEN').setFooter(`Powered by Pogy Devs`).setTitle(`Application #${ticketID}`).setDescription(`Hey ${member.user.username}! Your form was Submitted and ready to be judged.\n\n**Form ID**: \`${ticketID}\`\n**Time:** ${moment(new Date()).format("dddd, MMMM Do YYYY HH:mm:ss")}`)).catch(()=>{});
      ...
      if (Object.prototype.hasOwnProperty.call(data, "sendEmbed")) {
        ...
        if (ticketSettings.ticketToggle == "true") {
          ...
          if (ticketSettings.ticketType == "reaction" && ticketSettings.ticketCustom == "false") {
            ...
            if (storedSettings.isPremium == "false") {
              ticketSettings.ticketFooter = "Powered by Pogy Devs";
            } else {
            ...
            let reactionFooter = "Powered by Pogy Devs";



            let footer = "Powered by Pogy Devs";
            ...
            if (storedSettings.isPremium == "false") {
              ticketEmbed.setFooter(`Powered by Pogy Devs`)
            } else {
